...
function sendvideo(id, data, addr,idExtractor){
  ...
  axios.put('http://'+addr+':3000/api/project/'+id,{"data" :data, "idExtractor":idExtractor, "version":getVersion()})
  .then(function(response){
    ...
    fse.readFile('../descriptor.xsd',"utf8",function(err,descriptor){
      if(err){
        ...
        axios.put('http://'+addr+':3000/api/descriptor/'+getVersion(),{"data" :descriptor, "idExtractor":idExtractor})
        .then(function(response){
